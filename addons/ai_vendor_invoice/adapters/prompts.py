...
present. Preserve an explicitly printed tax treatment as one of
percentage, zero_rated, exempt, non_taxable, outside_scope, or other; do not
infer a special treatment from a numeric zero rate alone."""
